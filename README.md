...
Last Updated: `2026-06-02 04:21:27 UTC`

## 📊 Live DNS Status Table

| Server | Type | Address | Status | Speed (ms) | Ad-Block | Malware-Block |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 1 | ❌ | ❌ |
...
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 124 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 127 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 141 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 234 | ✅ | ❌ |
